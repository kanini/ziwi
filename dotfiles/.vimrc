...
set nowrap                     " wrapping off by default
set linebreak                  " but if we switch on wrapping, try not to wrap in the middle of words
...
set synmaxcol=500              " limit syntax highlighing
